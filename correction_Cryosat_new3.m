function correction_Cryosat_new3(ipparameter)
...
% ipparameter.path_dir_from2 : path to EGM file craeted previously
...
%--------------------------------------------------------------------------
% read EGM
%  filename2=fx_dir(path_dir_from2, 'egm.mat');
%  path_file_read2=fullfile(path_dir_from2, filename2(1,1).name);
%  egm=fx_load(path_file_read2); %to get the value in a field
%  F=scatteredInterpolant(egm.lon_vct, egm.lat_vct, egm.N2008_vct, 'linear'); 
