function dh_FINAL_combined_europe(ipparameter)
...
% ipparameter.path_dir_from1='E:\ICESAT_06_PROCESSED\EUROPE_DEC\GIS\New folder\';
% ipparameter.path_dir_to='E:\C_ICE_CS2\europe\';
% ipparameter.path_dir_from2='E:\GLACIER\C_EUROPE\CS2\DEC\GIS\CC\';
threshold=2;
%% ------------------READING THE DATA------------------------------------------------    
...
%         std_dh_time=std(dh_time);
        ...
        dh_time=dh_time(I2);
        med_ice(k)=median(dh_time)-20; %Median of values of a moimnth
    end
...
%     [b,stats] = robustfit(TIME, DH_ICE);
    % new_y2=new_y2+10;
     %% 
    filename_plot1='Europe.tif'; %filename same as whhat was read .tif
