function dh_FINAL_combined_n_arctic14(ipparameter)
...
% ipparameter.path_dir_from1='E:\ICESAT_06_PROCESSED\ARCTIC_CANADA_DEC\GIS\New folder\';
% ipparameter.path_dir_from2='E:\GLACIER\ARCTICCANADA_N\CS2\DEC\GIS\New folder\f\';
% ipparameter.path_dir_to='E:\C_ICE_CS2\arctic_can_n\NEW\';   
threshold=2;
%% ------------------READING THE DATA------------------------------------------------    
...
SRTM22=T2.m1;
SRTM23=T2.Merged;
SRTM24=str2double(SRTM23);

I1=find(~isnan(SRTM21));
I2=find(~isnan(SRTM22));
I3=find(~isnan(SRTM24));
SRTM=[SRTM21(I1);SRTM22(I2);SRTM24(I3)];
%SRTM=T2.MOSAIC;
I=find(SRTM>-1000);
TIME=TIME(I);
...
%     [b,stats] = robustfit(x, y);
    ...
    % new_y2=new_y2+10;
     %% 
    filename_plot1='ARC_CAN_N.tif'; %filename same as whhat was read .tif
