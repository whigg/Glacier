function dh_FINAL_combined_alaska_14(ipparameter)
...
% ipparameter.path_dir_from1='E:\ICESAT_14_PROCESSED\DEC\ALASKA\GIS\FINAL\New folder\';
% ipparameter.path_dir_to='E:\C_ICE_CS2\alaska\ice14\';
% ipparameter.path_dir_from2='E:\GLACIER\01_ALASKA\CS2\DEC\GIS\COMBINED\';
threshold=3;
%% ------------------READING THE DATA------------------------------------------------    
...
I=find(SRTM>-1000);
TIME=TIME(I);
DH_ICE=ELE_C(I) + GEOID_DIFF -SRTM(I);
...
%     [b,stats] = robustfit(x, y);
    ...
    % new_y2=new_y2+10;
     %% 
    filename_plot1='WHOLE3.tif'; %filename same as whhat was read .tif
