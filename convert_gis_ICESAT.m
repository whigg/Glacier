    function convert_gis_ICESAT(ipparameter)
    ...
    %T1=[s.deltaEllip, s.d_erElv, s.d_ldElv, s.d_eqElv, s.d_ElevBiasCorr, s.sat_corr_flg, s.sat_corr_flg, s.d_dTrop, s.d_wTrop];
    T1=[s.d_erElv, s.d_ldElv, s.d_eqElv, s.d_ElevBiasCorr, s.sat_corr_flg, s.sat_corr_flg];
    %cHeader2 = {'deltaEllip' 'd_erElv' 'd_ldElv' 'd_eqElv' 'ElevBiasCorr' 'sat_corr_flg', 'sat_corr_flg'}; %dummy header
    cHeader2 = {'d_erElv' 'd_ldElv' 'd_eqElv' 'ElevBiasCorr' 'sat_corr_flg', 'sat_corr_flg'}; %dummy header
