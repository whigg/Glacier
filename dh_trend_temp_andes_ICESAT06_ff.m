function dh_trend_temp_andes_ICESAT06_ff(ipparameter)
...
for iy=2003:2009
    ...
    if isempty(I2); continue;end
          ...
          if abs(median(dh_90_wint)) > 20
             if median(dh_90_wint)<0
                mdh0=[mdh0;-12];
...
for iy=2003:2009
    ...
    if isempty(I3); continue;end
        ...
        if abs(median(dh_90_summ)) > 20
         if median(dh_90_summ)<0
                mdh1=[mdh1;-12];
