function dh_FINAL_combined_andes14(ipparameter)
...
% ipparameter.path_dir_from1='E:\ICESAT_06_PROCESSED\ANDES_DEC\GIS\New folder\';
% ipparameter.path_dir_from2='E:\GLACIER\ANDES\CS2\DEC\GIS\New folder\';
% ipparameter.path_dir_to='E:\C_ICE_CS2\ANDES\New folder\';    
threshold=2;
%% ------------------READING THE DATA------------------------------------------------    
...
%month_AUT=["Dec","Jan","Feb"]; %for northern H
month_AUT=["Nov","Dec","Jan","Feb", "Mar"]; %for Southern H

% I=find(strcmp(month,month_AUT(1)) | strcmp(month,month_AUT(2)) | strcmp(month,month_AUT(3)) | strcmp(month,month_AUT(4)));
I=find(strcmp(month,month_AUT(1)) | strcmp(month,month_AUT(2)) | strcmp(month,month_AUT(3)) | strcmp(month,month_AUT(4)) | strcmp(month,month_AUT(5)));
...
%         I= find(dh_time>mean_dh_time-2*std_dh_time & dh_time< mean_dh_time+2*std_dh_time);
         I=find(abs(dh_time)<150);
         dh_time=dh_time(I);
        %med_ice(k)=median(dh_time(I)); %Median of values of a moimnth
        med_ice(k)=mean(dh_time); %Median of values of a moimnth
    end
...
%     [b,stats] = robustfit(x, y);
    ...
    % new_y2=new_y2+10;
     %% 
    filename_plot1='ANDES4.tif'; %filename same as whhat was read .tif
    ...
    plot(xx,yy,'y', 'LineWidth',1) %seasonal part
