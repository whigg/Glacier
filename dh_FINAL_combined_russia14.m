function dh_FINAL_combined_russia14(ipparameter)
...
% ipparameter.path_dir_from2='E:\GLACIER\RUSSIAN_ARCTIC\CS2\dec\GIS\final\';
% 
threshold=1.5;
%% ------------------READING THE DATA------------------------------------------------    
...
%     [b,stats] = robustfit(x, y);
    ...
    % new_y2=new_y2+10;
     %% 
    filename_plot1='russia2.tif'; %filename same as whhat was read .tif
