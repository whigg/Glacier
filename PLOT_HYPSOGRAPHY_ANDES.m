function PLOT_HYPSOGRAPHY_ANDES(ipparameter)
...
filename_plot1='HYPSOGRAPHY_DH_60.tif'; %filename same as whhat was read .tif
...
for k = 1:numel(center)
      text(center(k),Y(k),[sprintf('%.f',((Y(k)-X(k))*100)) '%'],'HorizontalAlignment','center','VerticalAlignment','bottom','FontSize',4);
end
